...
{
    [TestFixture]
    public class FormSectionDefinitionCollectionUnitTests
    {
        [Test]
        public void CollectionUsesCorrectKey()
        {
            // Arrange
            var sut = new FormSectionDefinitionCollection();
            var fakeControlDefinition = A.Fake<IFormSectionDefinition>();
